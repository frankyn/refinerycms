...
__WARNING__: This guide assumes you have followed the "Multiple Resources in an Extension" guide.
...
Overwrite /Users/cclogicimac/rails_projects/cclogic_app/vendor/extensions/events/lib/generators/refinery/events_generator.rb?
...
partial (all actions except `:show` and `:destroy`). Your controller should look like this when you are done:
